          ...
          <div class="modal-content">
            <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h4 class="modal-title">Tambah Skripsi Baru</h4>
            </div>
            <div class="modal-body">
              <?php echo form_open_multipart("Skripsi/input");?>
                <div class="box-body">
                  <div class="form-group">
                    <label for="password">skripsi</label>
                      <input type="text" class="form-control" id="password" placeholder="Skripsi" name="nama" required="required">
                  </div>
                  <div class="form-group">
              ...
              <table class="table table-bordered table-striped" id="example1">
                ...
                ?>
                  <tr>
                    ...
                    <td><a href="../assets/skripsi/<?php echo $key->gambar;?>"><img src="<?php echo base_url()?>/assets/skripsi/<?php echo $key->gambar;?>" title="<?php echo $key->nama;?>" width="100" height="100"></a></td>
                    <td><span class="label label-danger">Notification</span></td>
                    <td>

                      <button type="button" class="btn btn-xs btn-success" title="Edit skripsi" data-toggle="modal" data-target="#edit<?php echo $id;?>"><i class="fa fa-edit"></i></button>
                      <button type="button" class="btn btn-xs btn-danger" title="Hapus skripsi" data-toggle="modal" data-target="#delete<?php echo $id;?>"><i class="fa fa-trash"></i></button>
                  ...
                  <div class="modal fade" id="edit<?php echo $id;?>" role="dialog">
                    <div class="modal-dialog" >
                      <div class="modal-content">
                        <div class="modal-header">
                          <button type="button" class="close" data-dismiss="modal">&times;</button>
                          <h4 class="modal-title">Ubah Data skripsi</h4>
                        </div>
                        <div class="modal-body">
                          <div class="box-body">
                           <?php echo form_open_multipart("Skripsi/edit");?>
                             <div class="form-group">
                              <label for="password">skripsi</label>
                              <input type="hidden" class="form-control"   value='<?php echo $key->id_skripsi; ?>' name="id_skripsi" required="required" >
                  ...
                  <div class="modal fade" id="delete<?php echo $id;?>" role="dialog">
                    ...
                    <!-- Modal content-->
                      <div class="modal-content">
                        <div class="modal-header">
                          <button type="button" class="close" data-dismiss="modal">&times;</button>
                          <h4 class="modal-title">Hapus skripsi <?php echo $key->nama ?></h4>
                        </div>
                        <div class="modal-body">
                          <div class="alert alert-danger">Apakah anda yakin ingin menghapus skripsi ini?</div>
                        </div>
