                          ...
                          <div class="box-body">
                           <?php echo form_open_multipart("Pariwisata/edit");?>
                             <div class="form-group">
                              ...
                              <input type="hidden" class="form-control" value='<?php echo $key->pariwisata_image; ?>' name="pariwisata_image" required="required" readonly>
                            </div>
							<div class="form-group">
                              <label for="password">Foto Pariwisata</label>
                                <input type="file" class="form-control" id="password" placeholder="Foto"  name="gambar" >
                  ...
                  <div class="modal fade" id="delete<?php echo $id;?>" role="dialog">
                    ...
                    <div class="modal-content">
                      <?php echo form_open("Pariwisata/delete");?>
                            ...
                            <div class="modal-body">
                              <div class="alert alert-danger">Apakah anda yakin ingin menghapus "<b><?php echo $key->pariwisata_name?></b>" ?</div>
                            </div>
                            <div class="modal-footer">
                              <input type="hidden" class="form-control" value="<?php echo $key->pariwisata_id?>" name="pariwisata_id" required="required">
                              <input type="hidden" class="form-control" value="<?php echo $key->pariwisata_image?>" name="pariwisata_image" required="required">
