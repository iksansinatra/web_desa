								...
								<div class="about-block clearfix">
									...
									<div class="text-box mt-25">
										<div class="box-title mb-15">
											<h3><a href="<?php echo site_url("home/detail_berita?id=".$key3->news_id);?>"><?php echo $key3->news_title;?></a></h3>
										</div>
										<div class="text-content">

											<a href="<?php echo site_url("home/detail_berita?id=".$key3->news_id);?>" class="btn-text mt-15">Baca Selanjutnya</a>
										</div>
									</div>
								</div>
							</div>
