...
<html lang="en">
    <head>
        ...
        <title>Foto Desa / Desa Laywo Jaya</title><link rel="shortcut icon" type="image/x-icon" href="favicon.ico">
...
<!--loader-->
		...
		<!-- END HEADER -->
			...
			<div class="container">
				<div class="row title">
					<div class="title_row">
						<h1 data-title="Portfolio"><span>Foto Desa</span></h1>
						<div class="page-breadcrumb">
							<a>Galeri</a>/<a>Foto Desa</a>
						</div>
            ...
            if($this->uri->segment(2)=="index"){
  					...
  					?>
  						<div class="nf-item branding coffee spacing">
  							<div class="item-box">
  								<a> <img alt="1" src="<?php echo base_url();?>assets/foto/<?php echo $key2->image_file;?>" class="item-container" height="250"> </a>
  								<div class="link-zoom">

  									<a href="<?php echo base_url();?>assets/foto/<?php echo $key2->image_file;?>" class="fancylight popup-btn same_style" data-fancybox-group="light" > <i class="fa fa-search-plus"></i> </a>
