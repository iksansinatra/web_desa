...
<html lang="en">
	<head>
		...
		<title>Potensi / Desa Laywo Jaya</title><link rel="shortcut icon" type="image/x-icon" href="favicon.ico">
				...
				?>
						...
						<div class="col-md-6 col-lg-4 mb-30">
							<div class="service_box">
								...
								<h3><a href="<?php echo site_url("home/detail_potensi?id=".$key->potensi_id);?>"><?php echo $key->potensi_name;?></a></h3>
								<p>
									<?php
							...
							<center><a href="<?php echo site_url("home/detail_potensi?id=".$key->potensi_id);?>" class="btn-text">Baca Selanjutnya</a> </center>
						</div>
