	...
	<body>
		...
		<section class="inner-intro bg-img light-color overlay-before parallax-background">
			<div class="container">
				<div class="row title">
					<div class="title_row">
						<h1 data-title="Project Details"><span>Detail Potensi</span></h1>
						<div class="page-breadcrumb">
							<a>Potensi Desa</a>/ <span>Detail Potensi</span>
						</div>
				...
				<div class="row">
					<div class="col-sm-12">
						<div class="project-details">
							<figure>
                <?php
                foreach ($potensi as $key1) {

                ?>
								<center><img src="<?php echo base_url();?>assets/potensi/<?php echo $key1->potensi_image;?>" alt="" width="1920" height="512"></center>
							</figure>
					...
					<div class="col-sm-12 col-lg-7 mt-30">
						<div class="box-title mb-20">
							<h3><?php echo $key1->potensi_name;?></h3>
						</div>
						<div class="text-content">
							<p>
								<?php echo $key1->potensi_desc;}?>
							</p>
		...
		<div class="padding gray-bg ptb-xs-40">
			<div class="container">
              ...
              <?php
               $no=1;
               foreach ($potensi1 as $key3) {
              ?>
							<div class="project-item">
								<div class="about-block clearfix">
									<figure>
										<a href="<?php echo base_url();?>assets/potensi/<?php echo $key3->potensi_image;?>"><img class="img-responsive" src="<?php echo base_url();?>assets/potensi/<?php echo $key3->potensi_image;?>" alt="Photo" height="200"></a>
									</figure>
									<div class="text-box mt-25">
										<div class="box-title mb-15">
											<h3><a href="<?php echo site_url("home/detail_potensi?id=".$key3->potensi_id);?>"><?php echo $key3->potensi_name;?></a></h3>
										</div>
										<div class="text-content">

											<a href="<?php echo site_url("home/detail_potensi?id=".$key3->potensi_id);?>" class="btn-text mt-15">Baca Selanjutnya</a>
										</div>
									</div>
								</div>
							</div>
