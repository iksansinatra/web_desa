								...
								<div class="about-block clearfix">
									...
									<div class="text-box mt-25">
										<div class="box-title mb-15">
											<h3><a href="<?php echo site_url("detail-potensi-desa?id=".$key3->potensi_id);?>"><?php echo $key3->potensi_name;?></a></h3>
										</div>
										<div class="text-content">

											<a href="<?php echo site_url("detail-potensi-desa?id=".$key3->potensi_id);?>" class="btn-text mt-15">Baca Selanjutnya</a>
										</div>
									</div>
								</div>
							</div>
