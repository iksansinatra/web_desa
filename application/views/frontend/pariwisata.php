...
<html lang="en">
	<head>
		...
		<title>Pariwisata / Desa Laywo Jaya</title><link rel="shortcut icon" type="image/x-icon" href="favicon.ico">
				...
				?>
						...
						<div class="col-md-6 col-lg-4 mb-30">
							<div class="service_box">
								...
								<h3><a href="<?php echo site_url("home/detail_pariwisata?id=".$key->pariwisata_id);?>"><?php echo $key->pariwisata_name;?></a></h3>
								<p>
									<?php
