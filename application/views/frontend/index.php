				...
				<div id="rev_slider_34_1" class="rev_slider" data-version="5.0.7">
					<ul>
						...
						<li data-index="rs-129"  >
							<!-- MAIN IMAGE -->
							<img src="<?php echo base_url()?>assets/assets/images/banner/slider1.jpg"  alt=""  class="rev-slidebg" >
							<!-- LAYERS -->
							<!-- LAYER NR. 2 -->
						...
						<li data-index="rs-130" data-title="" data-description="">
							<!-- MAIN IMAGE -->
							<img src="<?php echo base_url()?>assets/assets/images/banner/slider2.jpg"  alt=""   class="rev-slidebg">
							<!-- LAYERS -->
							<!-- LAYER NR. 2 -->
							<div class="tp-caption Newspaper-Title   tp-resizeme "
						...
						<li data-index="rs-131">
							<!-- MAIN IMAGE -->
							<img src="<?php echo base_url()?>assets/assets/images/banner/slider3.jpg"  alt=""   class="rev-slidebg " >
							<!-- LAYERS -->
							<!-- LAYER NR. 2 -->
							<div class="tp-caption Newspaper-Title   tp-resizeme "
