...
class Link extends CI_Controller {
    ...
    public function index(){
      if(!($this->session->userdata('userid'))){
          ...
          $data['link']=$this->M_link->tampil_data_link();
    ...
    public function input() {
       ...
       $config['upload_path'] = './assets/link/'; //path folder
       ...
       if($_FILES['gambar']['name'])
        ...
        //redirect to page
          ...
          redirect('Link'); //jika berhasil maka akan ditampilkan view vupload
    }
